  ...
  return (
    <section className="container my-5 py-2  ">
      ...
      <div className="  row align-items-center justify-content-center position-relative" >
        <div className="col-12 col-lg-4 d-flex justify-content-center justify-content-lg-end position-relative mb-4 mb-lg-0" style={{ zIndex: 10, left: "10%" }}>
          {imageSrc && (
            <div className="position-relative w-100" style={{ maxWidth: '300px', height: '300px' }}>
              <Image
                src={imageSrc}
                alt="Review Image"
                layout="fill"
        ...
        <div className="col-12 col-lg-8 px-4 py-5 rounded" style={{
          ...
          <h2 className="fw-bold fs-4 mb-4 text-center text-lg-start">
            {title}
          </h2>
              ...
              renderReviewItem ? (
                ...
                <li key={index} className="d-flex align-items-start mb-3">
                  <div className="d-flex align-items-center justify-content-center me-3" style={{ minWidth: "32px", height: "32px" }}>
                    <FaRegCheckCircle className="fs-4" style={{ color: "#083c61" }} aria-hidden="true" />
                  </div>
