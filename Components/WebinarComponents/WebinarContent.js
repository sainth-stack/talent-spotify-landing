...
export function WebinarContent({ image1 }) {
  return (
    <div className="container-fluid">
      <div className="d-flex flex-wrap align-items-start justify-content-center">
        ...
        <div className="paragraph">
          <h3 className="heading1">Get access to our Latest  webinar</h3>
          ...
          <div>
            ...
            <div className="webinarBody">
              <p className="webinar-title">
                7PM | How To Measure Your OKRs Successfully
              </p>
              <p className="webinar-description">
                Next new webinar coming in Autumn 2022. See previously recorded
                webinars below.
              </p>
            </div>
            <div className="d-flex">
            ...
            <div className="webinarBody">
              <p className="webinar-title">
                8AM | How To Measure Your OKRs Successfully
              </p>
              <p className="webinar-description">
                Next new webinar coming in Autumn 2022. See previously recorded
                webinars below.
            ...
            <div className="webinarBody">
              <p className="webinar-title">
                9AM | How To Measure Your OKRs Successfully
              </p>
              <p className="webinar-description">
                Next new webinar coming in Autumn 2022. See previously recorded
                webinars below.
                ...
                <div className="modal-body">
                  <div className="embed-responsive embed-responsive-16by9">
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/zVJ9weT7SyU"
                      allowFullScreen
                    ></iframe>
                  </div>
                </div>
