...
export function Nav({
  ...
  const showHiddenMobile = () => {
    document.getElementById("showMenuMobile").style.display =
      document.getElementById("showMenuMobile").style.display === "block"
        ? "none"
        : "block";
  };
  ...
  return (
    <div
      className={`tablet_nav justify-content-between align-items-center pt-2 pb-2 ${
        !isMobile ? "d-flex custom-padding" : "p-3 "
      }`}
      style={{
        background: isMobile ? "white" : "#EAE3D6",
        boxShadow: isMobile ? "0px 2px 4px 0px #00000014" : "",
        position: "fixed",
        top: 0,
        right: 0,
        left: 0,
    ...
    >
      ...
      <div
        className="tablet_login d-lg-flex"
